...
function ProductPagedataP() {
  ...
  const SetLabel = () => {
    ...
    const EditLabel = async () => {
      ...
      const remarkS = alllabel.remarkS
      try {
        await axios.put(`/api/${apilabeldata}/${Number(alllabel.id)}`, { code, indicatorlistS, timeS, useS, timeuseS, keepS, remarkS })
          ...
          <div className="image-upload-container">
            <div className="image-preview">
              {all.pic == null || preview !== null ? (
                ...
                <img src={"/api" + String(all.pic) + "?t=" + Date.now()} alt="product" />
              )}
            </div>
