...
function MobileProductPage() {
  ...
  const [activeTab, setActiveTab] = useState('stockchange');
  ...
  const [showcolor, setshowcolor] = useState("4");
    ...
    <>
      ...
      <div className="mobile-product-app">
        ...
        <div className="product-header">
          ...
          <div className="scanner-container" style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
            <div
            ...
            >
              ...
              <span style={{ color: '#9ca3af', fontSize: '15px' }}>ค้นหาสินค้า...</span>
            </div>
            <button
