...
export default function SidebarNav() {
  return (
    <ul className="list-unstyled">
     ...
     {/**<SidebarNavTitle>หน้าขาย</SidebarNavTitle>
      ...
      <SidebarNavGroup toggleIcon={faPuzzlePiece} toggleText="หน้าขาย">
     ...
     <SidebarNavGroup toggleIcon={faLocationArrow} toggleText="สินค้า">
      ...
      <SidebarNavItem icon={faComments} href="/web/chat">
        แชท Omnichannel
        <small className="ms-auto"><Badge bg="success">NEW</Badge></small>
      </SidebarNavItem>
